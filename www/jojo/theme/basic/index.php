...
<div class="latest_top_wr">
	<style>
		.latest_top_wr {display:block}
		.latest_top_wr > ul {overflow:hidden}
		.latest_top_wr > li {width: 50%; float:left}
	</style>
...
<div class="latest_wr">
	...
	echo latest('theme/pic_list', 'business', 4, 23);	
    ?>
